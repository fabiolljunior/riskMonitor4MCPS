 ...
 *
 */
public class BBNGeNIeHandler_Config2 implements BBNHandlerIF {
	...
	private static BBNGeNIeHandler_Config2 singleton = null;
	// TODO:refactor
	private static String filePath = "resources/RiskMonitoringNetMCPS_v3_Config2.xdsl";
	private Network net = null;

	private BBNGeNIeHandler_Config2() {
		net = new Network();

		net.readFile(filePath);
		System.out.println("BBNGeNIeHandler_Config2 leu...");

		net.updateBeliefs();
		System.out.println("BBNGeNIeHandler_Config2 atualizou...");

		// TODO: set all the current evidences
		updateScenarioInitial();
//		updateConfigurationSILA();
		updateConfigurationSILC();
		System.out.println("BBNGeNIeHandler_Config2 configurou...");
	}
	
	@Override
	public String toString() {
		return "BBNGeNIeHandler_Config2";
	}
...
//		System.out.println("BBNGeNIeHandler.updateHR() - vai atualizar: " + value + " critic level: " + criticLevel.getName());
		net.setEvidence(HR_SENSOR_VALUE_NODE_NAME, value+"");
		net.updateBeliefs();
		return updateRisk();
...
//		System.out.println("BBNGeNIeHandler.updateRisk() currentRisk: " + currentRisk);
	...
	public static BBNGeNIeHandler_Config2 getInstance() {
		if (singleton == null) {
			singleton = new BBNGeNIeHandler_Config2();
		}
		return singleton;
	}
}
